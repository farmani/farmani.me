 ...
 */
class BasePortfolio extends CTBaseActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('update_time, delete_time, release_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, title, body, url, create_time, update_time, delete_time, release_date', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return BasePortfolio the static model class
	 */
