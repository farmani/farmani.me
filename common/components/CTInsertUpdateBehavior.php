<?php
/**
 * CTInsertUpdateBehavior.php class
 *
...
/**
 * The CTInsertUpdateBehavior extension adds up some functionality to the default
 ...
 * $command->attachBehavior('CTInsertUpdateBehavior', new CTInsertUpdateBehavior);
 ...
 */
class CTInsertUpdateBehavior extends CBehavior
{
    /**
