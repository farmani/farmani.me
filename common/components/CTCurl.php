 ...
 **/
class CTCurl extends CComponent
{
    ...
    public function post_file($params = array(), $options = array())
    {
        $this->post($params, $options);

        // CURLOPT_POSTFIELDS must be an array if files are passed with the "@" prefix.
        // @link php.net/manual/function.curl-setopt.php
        $this->option(CURLOPT_POSTFIELDS, $params);
    }
